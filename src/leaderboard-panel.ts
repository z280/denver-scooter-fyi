...
export function buildAboutHtml(): string {
  return [
    ...
    `<p><strong>Total Regional Points</strong> ranks riders across the whole city rather than hexagon by hexagon, and it's live: points you earn show up the next time you open it, not the next morning.</p>`,
