...
//
// Fail-closed for Google, fail-open for email: if the endpoint is
// unreachable we hide Google (no client id to trust) but still show the email
// doors, which degrade gracefully to a friendly error if the server 503s.
